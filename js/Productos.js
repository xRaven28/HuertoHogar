...
// Funciones de render (cliente y admin)
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="d-flex align-items-center justify-content-between mt-2">
                ...
                <div class="btn-group">
                  ...
                  <button class="btn btn-outline-danger btn-sm btn-fav" data-id="${p.id}" data-name="${p.name}" data-precio="${p.precio}" data-img="${p.img}">
...
function agregarProducto(nombre, precio, desc, categoria, img) {
    const nuevo = {
