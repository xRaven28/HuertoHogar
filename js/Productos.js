const CATALOGO = [
    ...
    { id: "19", name: "Higos", precio: 3500, categoria: "frutas", img: "img/higo/Higo_1.png", desc: "Higos frescos, dulces y jugosos, ideales para postres o mermeladas." },
    { id: "20", name: "Arándanos", precio: 4200, categoria: "frutas", img: "img/arandano/Arandano_1.png", desc: "Arándanos pequeños, azules y llenos de antioxidantes." },
    { id: "21", name: "Piña", precio: 2800, categoria: "frutas", img: "img/pina/Pina_1.png", desc: "Piña tropical, jugosa y refrescante, perfecta para jugos y postres." },
    { id: "22", name: "Limón", precio: 1500, categoria: "frutas", img: "img/limon/Limon_1.png", desc: "Limones frescos, llenos de jugo ácido y vitamina C." },
    { id: "23", name: "Castañas", precio: 7600, categoria: "frutas", img: "img/castana/Castana_1.png", desc: "Castañas frescas, ideales para asar o preparar purés." },
    { id: "24", name: "Caqui", precio: 2990, categoria: "frutas", img: "img/albaricoque/Albaricoque_1.png", desc: "Caquis dulces y jugosos, ideales para mermeladas y postres." },
    { id: "25", name: "Chirimoya", precio: 3800, categoria: "frutas", img: "img/chirimoya/Chirimoya_1.png", desc: "Chirimoya cremosa y muy dulce, conocida como la 'fruta de la paz'." },
    { id: "26", name: "Tuna", precio: 2200, categoria: "frutas", img: "img/tuna/Tuna_1.png", desc: "Tunas frescas, dulces y refrescantes, típicas de temporada." },
    { id: "27", name: "Nueces", precio: 8500, categoria: "frutas", img: "img/nuez/Nuez_1.png", desc: "Nueces frescas con alto contenido de omega-3 y energía." },
    { id: "28", name: "Almendras", precio: 8900, categoria: "frutas", img: "img/almendra/Almendra_1.png", desc: "Almendras naturales, crocantes y llenas de nutrientes." },
    { id: "29", name: "Pomelo", precio: 2300, categoria: "frutas", img: "img/pomelo/Pomelo_1.png", desc: "Pomelos jugosos y ácidos, ricos en vitamina C." },
    { id: "30", name: "Alcayota", precio: 2500, categoria: "frutas", img: "img/alcayota/Alcayota_1.png", desc: "Alcayota fresca, especial para preparar dulces y mermeladas." },
    // VERDURAS
    { id: "31", name: "Lechuga", precio: 900, categoria: "verduras", img: "img/lechuga/Lechuga_1.png", desc: "Fresca y crujiente, ideal para ensaladas." },
    { id: "32", name: "Repollo Blanco", precio: 1000, categoria: "verduras", img: "img/repollo/RepolloBlanco_1.png", desc: "Repollo blanco, crocante y versátil en ensaladas o guisos." },
    { id: "33", name: "Repollo Morado", precio: 1100, categoria: "verduras", img: "img/repollo/RepolloMorado_1.png", desc: "Repollo morado, de color intenso y sabor fresco." },
    ...
    { id: "47", name: "Coliflor", precio: 1800, categoria: "verduras", img: "img/coliflor/Coliflor_1.png", desc: "Coliflor fresca, ideal para gratinados, sopas y ensaladas." },
    { id: "48", name: "Ajo", precio: 1200, categoria: "verduras", img: "img/ajo/Ajo_1.png", desc: "Ajo aromático, infaltable en la cocina chilena." },
    { id: "49", name: "Betarraga", precio: 1600, categoria: "verduras", img: "img/betarraga/Betarraga_1.png", desc: "Betarraga dulce y nutritiva, rica en antioxidantes." },
    { id: "50", name: "Choclo", precio: 1800, categoria: "verduras", img: "img/choclo/Choclo_1.png", desc: "Choclo fresco, amarillo y jugoso, perfecto para humitas y pastel de choclo." },
    { id: "51", name: "Cebollín", precio: 1200, categoria: "verduras", img: "img/cebollin/Cebollin_1.png", desc: "Cebollín fresco, ideal para ensaladas y guisos." },
    { id: "52", name: "Cebolla Morada", precio: 1400, categoria: "verduras", img: "img/cebollaMorada/CebollaMorada_1.png", desc: "Cebolla morada, de sabor suave y dulce, perfecta para ensaladas." },
    { id: "53", name: "Berenjena", precio: 2000, categoria: "verduras", img: "img/berenjena/Berenjena_1.png", desc: "Berenjena morada, ideal para asar, freír o rellenar." },
    { id: "54", name: "Ají", precio: 1500, categoria: "verduras", img: "img/aji/Aji_1.png", desc: "Ají fresco, aporta picor y sabor intenso a las comidas." },
    { id: "55", name: "Rabanito", precio: 1000, categoria: "verduras", img: "img/rabanito/Rabanito_1.png", desc: "Rabanitos frescos, crujientes y de sabor ligeramente picante." },
    { id: "56", name: "Alcachofa", precio: 2800, categoria: "verduras", img: "img/alcachofa/Alcachofa_1.png", desc: "Alcachofas tiernas, ricas en fibra y antioxidantes." },
    { id: "57", name: "Espárragos", precio: 3500, categoria: "verduras", img: "img/esparrago/Esparrago_1.png", desc: "Espárragos frescos, tiernos y sabrosos." },
    { id: "58", name: "Cilantro", precio: 800, categoria: "verduras", img: "img/cilantro/Cilantro_1.png", desc: "Cilantro fresco, aromático e indispensable en la cocina chilena." },
    { id: "59", name: "Perejil", precio: 700, categoria: "verduras", img: "img/perejil/Perejil_1.png", desc: "Perejil fresco, perfecto para salsas, guisos y ensaladas." },
    { id: "60", name: "Apio", precio: 1100, categoria: "verduras", img: "img/apio/Apio_1.png", desc: "Crujiente y refrescante, ideal para ensaladas y sopas." },
    ...
    { id: "69", name: "Mantequilla", precio: 2900, categoria: "Lacteos", img: "img/mantequilla/Mantequilla_1.png", desc: "Mantequilla cremosa, perfecta para untar o cocinar." },
    { id: "70", name: "Queso Chanco", precio: 8900, categoria: "Lacteos", img: "img/queso/QuesoChanco_1.png", desc: "Queso chanco tradicional, semimaduro y sabroso." },
    { id: "71", name: "Queso Mantecoso", precio: 9500, categoria: "Lacteos", img: "img/queso/QuesoMantecoso_1.png", desc: "Queso mantecoso, suave y fundente, ideal para sándwiches." },
    { id: "72", name: "Queso de Cabra", precio: 10500, categoria: "Lacteos", img: "img/queso/QuesoCabra_1.png", desc: "Queso de cabra artesanal, de sabor intenso y textura cremosa, ideal para ensaladas y tablas." },
    { id: "73", name: "Yogurt", precio: 450, categoria: "Lacteos", img: "img/yogurt/Yogurt_1.png", desc: "Yogurt natural, fresco y nutritivo." },
    ...
    { id: "80", name: "Mermelada de Higo", precio: 2800, categoria: "otros", img: "img/Mermeladas/MermeladaHigo_1.png", desc: "Mermelada casera de higo, dulce e intensa." },
    { id: "81", name: "Mermelada de Alcayota", precio: 2800, categoria: "otros", img: "img/Mermeladas/MermeladaAlcayota_1.png", desc: "Tradicional mermelada de alcayota, típica de la cocina chilena." },
    { id: "82", name: "Mermelada de Frambuesa", precio: 2800, categoria: "otros", img: "img/Mermeladas/MermeladaFrambuesa_1.png", desc: "Mermelada de frambuesa fresca, intensa y natural." },
    { id: "83", name: "Mermelada de Arándano", precio: 2800, categoria: "otros", img: "img/Mermeladas/MermeladaArandano_1.png", desc: "Mermelada artesanal de arándano, llena de sabor." },
];
